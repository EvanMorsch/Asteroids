...
init = function() {
	...
	asteroids.forEach(function(a, b){this[b]=new Asteroid(new _vector(Math.round(Math.random())*SCREENWIDTH, Math.round(Math.random())*SCREENHEIGHT))}, asteroids)//fill with different asteroids
	bullets = []
	particles = []
