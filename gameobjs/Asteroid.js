...
class Asteroid extends Entity {
	constructor(world, pos, size=ASTEROID_DEFAULT_SIZE) {
	...
	collide(coll_with) {//spawn new asteroids if needed and kill the asteroid
		...
		if (this.heightMap.min >= ASTEROID_MIN_PARENT_SIZE)
		{
			...
			{
				this.world.entities.push(new Asteroid(this.world, this.pos, this.heightMap.min*ASTEROID_CHILD_SCALE))
			}
		}
	}
	draw()
